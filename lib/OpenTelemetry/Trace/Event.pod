...
Probably the most common event will be exceptions added through the span
object's L<record_exception|OpenTelemetry::Trace::Span/record_exception>
method.
...
create events on a span using the
L<add_event|OpenTelemetry::Trace::Span/add_event> method instead.
